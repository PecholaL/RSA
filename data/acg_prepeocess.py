""" Collect .wav files in the directory
    trim the silent segments
    clip .wav into x-second pieces
"""
...
if __name__ == "__main__":
    ...
    audio_segment_len = config["asv_audio_segment_len"]
    ...
    # Dump Pickle
    with open(os.path.join(out_path, "acg_audio.pkl"), "wb") as f:
        pickle.dump(data, f)
        print(f"[Dataset]dumped pickle to {os.path.join(out_path, 'acg_audio.pkl')}")
